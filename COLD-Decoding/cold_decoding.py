...
def options():
    ...
    parser.add_argument("--beam-search", type=int, default=-1)
...
def decode(model, tokenizer, device, x="", z="", constraints=None, args=None, model_back=None, zz=None, n_r):
    '''
    ...
    torch.save(y_logits_, "/users/ug21/sachiray/AML/COLD_decoding/tensors/y_logits_" + str(n_r) + ".pt")
    torch.save(soft_forward_x, "/users/ug21/sachiray/AML/COLD_decoding/tensors/soft_forward_x" + str(n_r) + ".pt")
    torch.save(z_mask, "/users/ug21/sachiray/AML/COLD_decoding/tensors/z_mask" + str(n_r) + ".pt")
